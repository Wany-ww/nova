...
function show_gui(src : table)
    ...
    gui.config.set("plotGraph##pl", "plot2d", "legend_text_color", {245, 224, 220, 255})
    gui.config.set("plotGraph##pl", "plot2d", "legend_background_color", {30, 30, 46, 220})
    ...
    gui.config.set("plot3dGraph##p3", "plot3d", "legend_text_color", {245, 224, 220, 255})
    gui.config.set("plot3dGraph##p3", "plot3d", "legend_background_color", {30, 30, 46, 220})
